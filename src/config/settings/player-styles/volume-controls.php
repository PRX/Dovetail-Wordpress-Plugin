...
return [
	...
	'fields' => [
		...
		[
			'name'      => 'volume-controls--slider--surface',
			'class'     => 'dtpc-player-style',
			'component' => 'volume-controls',
			'part'      => 'slider',
			'property'  => 'surface',
			'label'     => __( 'Volume Controls Slider Surface Color', 'dovetail-podcasts' ),
			'desc'      => '<p>' . __( 'Color of volume controls slider\'s surface. Defaults to <em>Player Surface Color</em> or transparent shade of <em>Player Foreground Color</em>.', 'dovetail-podcasts' ) . '</p>',
			'type'      => 'color',
		],
	],
];
