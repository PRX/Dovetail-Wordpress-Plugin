...
const DtpcPlayButton = class {
  constructor(hostRef) {
    ...
    this.togglePaused = (0,_index_DqrFfVsn_js__WEBPACK_IMPORTED_MODULE_0__.d)(this, "audio-toggle-paused", 7);
  }
  componentWillLoad() {
    const self = this;
  ...
  render() {
    ...
    return (0,_index_DqrFfVsn_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_DqrFfVsn_js__WEBPACK_IMPORTED_MODULE_0__.a, {
      ...
      ...buttonAttributes
    }, playing ? (0,_index_DqrFfVsn_js__WEBPACK_IMPORTED_MODULE_0__.h)("icon-pause", null) : (0,_index_DqrFfVsn_js__WEBPACK_IMPORTED_MODULE_0__.h)("icon-play", null)));
  }
};
...
//# sourceMappingURL=web-components_dist_dovetail-podcasts-player-web-components_dtpc-play-button_entry_js.js.map?ver=9f0a8d90ea680c4aded7