...
Easily integrate with Dovetail, PRX's podcasting publishing platform, to streamline your podcast production workflow.
...
* chore(workflows): validate version (https://github.com/jasonbahl/automation-tests/pull/71)

= 0.4.0 =

**New Features**

* feat: Upload files directly to Dovetail (https://github.com/jasonbahl/automation-tests/pull/66)

**Bug Fixes**

* fix(postmetabox): Disable scrubbing of upload playback url (https://github.com/jasonbahl/automation-tests/pull/68)

= 0.3.2 =

**Bug Fixes**

* fix(dovetailapi): Add cache-control header (https://github.com/jasonbahl/automation-tests/pull/63)
