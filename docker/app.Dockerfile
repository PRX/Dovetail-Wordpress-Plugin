...
LABEL author=rpeterman-gp
LABEL author_uri=https://github.com/rpeterman-gp
...
ENV UPLOADS_DIR="${WP_ROOT_FOLDER}/wp-content/uploads"
ENV PLUGINS_DIR="${WP_ROOT_FOLDER}/wp-content/plugins"
ENV PROJECT_DIR="${PLUGINS_DIR}/dovetail-podcasts"
