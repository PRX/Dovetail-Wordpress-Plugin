---
title: "chore(workflows): validate version"
pr: 71
author: "rpeterman-gp"
type: "chore"
breaking: false
...
- updates workflows to validate version
- fix Dovetail API to ensure uncut duration value exists before converting it to a float
...
Changes include linter formatting. Code to review throws an error when version value does not validate. Look for \`isValidVersion\` variable for affected code blocks.
